-- Script untuk menambahkan data dummy users ke Supabase
-- Jalankan script ini di SQL Editor di Supabase Dashboard

-- Insert dummy users ke auth.users (Supabase Auth) - dengan ON CONFLICT
...
-- Insert profiles untuk users - dengan ON CONFLICT
